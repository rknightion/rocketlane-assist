        ...
        if headers:
            for header_pair in headers.split(","):
                if "=" in header_pair:
                    ...
                    print(f"Header: {key} = {'***' if key.lower() == 'authorization' else decoded_value[:20] + '...' if len(decoded_value) > 20 else decoded_value}")
        ...
        if headers:
            for header_pair in headers.split(","):
                if "=" in header_pair:
                    ...
                    print(f"gRPC Metadata: {key.lower()} = {'***' if key.lower() == 'authorization' else decoded_value[:20] + '...'}")
